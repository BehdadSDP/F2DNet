...
data_root = '/content/F2DNet/datasets/CityPersons/'
INF = 1e8
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/cp/ecp_h36/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/ecp/hard36/epoch_55.pth'
resume_from = None
